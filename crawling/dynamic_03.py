...
more = driver.find_element(By.XPATH,'//*[@id="autodanawa_gridC"]/div[3]/article/main/div/div[3]/div[1]/a') #xpath 불러오기
...
cdatas = soup.select('#autodanawa_gridC > div.gridMain > article > main > div > table > tbody > tr')
for row in cdatas:
    cdatas = row.select('td')
    print(cdatas[0].text.strip())
    time.sleep(1)
            
#autodanawa_gridC > div.gridMain > article > main > div > table > tbody
time.sleep(10)
# 브라우져 종료
driver.quit()