...
# top_10 = driver.find_element(By.XPATH, '//*[@id="tab-list"]/li[1]/button')
# top_10.click()
# time.sleep(2)


           
# cdatas = soup.select('#accordion-specification>')
# for row in cdatas:
#     Q_datas = row.select('td')
#     print(cdatas[0].text.strip())
#     time.sleep(1)

# 버튼 클릭 accordion-item-0-button  ~ accordion-item-9-button
...
# body_soup = soup.select('.container.responsivegrid')
...
# # 모든 panel 안의 <p>만 선택
# body_soup = soup.select("div[data-cmp-hook-accordion='panel'] p")
